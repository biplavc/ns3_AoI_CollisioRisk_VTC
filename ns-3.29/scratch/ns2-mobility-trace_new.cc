...
int main (int argc, char *argv[])
{
  ...
  std::string loc_name ("highway_veh_2.txt"); 
  ...
  int nodeNum=50;
  double duration=370; // see important.txt on sumo folder
...
//   LogComponentEnable ("Ns2MobilityHelper",LOG_LEVEL_DEBUG);
  ...
  Ns2MobilityHelper ns2 = Ns2MobilityHelper ("/home/biplav/mobility_files/highway_veh_2.tcl"); // 300 simulation seconds of 99 vehicles
  // Create all nodes.
  NodeContainer stas;
  stas.Create (nodeNum);
...
//   int tt = t.GetInteger();
  ...
  for (i = 0; i<nodeNum; i++)
  {
    ...
    //   Simulator::Schedule(Seconds (173->GetValue()), &LogLocation, i, LogInterval);
      Simulator::ScheduleWithContext((NodeList::GetNode(i))->GetId (), Seconds (350), &LogLocation, i, LogInterval);
  }
