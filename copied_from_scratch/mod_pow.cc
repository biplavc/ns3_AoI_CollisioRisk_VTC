...
int main (int argc, char *argv[])
{
  ...
  //intervals as per      1,   5,   10,            15,        20,   25,        30            35,              50,  80 Hz
  double intervals[] = {1.0, 0.2, 0.1, 0.06666666666666667, 0.05, 0.04, 0.03333333333, 0.02857142857142857, 0.02, 0.0125};
  ...
  for (int yyy = 0; yyy <kk; yyy++) //loop over intervals
  {
    ...
    for (int m = 0; m < mm; m++)
    {
        ...
        {
          int power_levels[] = {20,24,28,32};
          int ttt =  (sizeof(power_levels)/sizeof(*power_levels));
          for (int rrr = 0; rrr < ttt; rrr++)
          ...
          wifiPhy.Set ("TxPowerStart", DoubleValue (power_levels[rrr]) );
          wifiPhy.Set ("TxPowerEnd", DoubleValue (power_levels[rrr]) );
          ...
          ss_3 << int(power_levels[rrr]);
          std::string str_3 = ss_3.str();

          std::string file_name ("EQ_" + queue_here + "_" + str_2 + "Hz_" + str_1 + "U" + str_3 + "P.txt"); 
        //   std::cout<<"str_3 = "<<str_3<<std::endl;
          ...
          std::string loc_name ("Drop_" + queue_here + "_" + str_2 + "Hz_" + str_1 + "U" + str_3 + "P.txt"); 
          ...
          for (int i = 0; i < nSinks; i++)
          {
              ...
              // Ptr<WifiNetDevice> wifiDevice = DynamicCast<WifiNetDevice> (device_0);
