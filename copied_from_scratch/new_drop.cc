...
int main (int argc, char *argv[])
{
  ...
  double intervals[] = {0.016666666666666666};
  ...
  for (int yyy = 0; yyy <kk; yyy++) //loop over intervals
  {
    ...
    for (int m = 0; m < mm; m++)
    {
        ...
        Config::Set ("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::RegularWifiMac/$ns3::OcbWifiMac/Txop/Queue/MaxSize", StringValue ("10p"));
        Config::Set ("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::RegularWifiMac/$ns3::OcbWifiMac/VO_Txop/Queue/MaxSize", StringValue ("10p"));
        Config::Set ("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::RegularWifiMac/$ns3::OcbWifiMac/VI_Txop/Queue/MaxSize", StringValue ("10p"));
        Config::Set ("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::RegularWifiMac/$ns3::OcbWifiMac/BE_Txop/Queue/MaxSize", StringValue ("10p"));
        Config::Set ("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::RegularWifiMac/$ns3::OcbWifiMac/BK_Txop/Queue/MaxSize", StringValue ("10p"));
        ...
        std::string file_name ("New_q0_" + str_2 + "Hz_" + str_1 + "U.txt"); 
        ...
        std::string file_name_1 ("Error_Test" + str_2 + "Hz_" + str_1 + "U.txt"); 
        ...
        std::cerr<<collisions_MacTxDrop<<" "<<collisions_PhyTxDrop<<" "<<collisions_PhyRxDrop<<" "<<collisions_MacRxDrop<<std::endl;
