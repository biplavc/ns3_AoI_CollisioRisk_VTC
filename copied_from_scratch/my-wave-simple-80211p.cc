  ...
  while (packet = socket->Recv ())
    {
      ...
      NS_LOG_UNCOND ("Received one packet and the queue size is!");
      // uint32_t queue_size;
...
int main (int argc, char *argv[])
{
  ...
  Config::Set("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::RegularWifiMac/$ns3::OcbWifiMac/Txop/Queue/MaxSize", QueueSizeValue(QueueSize(QueueSizeUnit::PACKETS,1)));
  ...
  //Config::Set("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::RegularWifiMac/Txop/Queue::MaxQueueSize",StringValue("1p"));
  //Config::Set ("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::RegularWifiMac/$ns3::OcbWifiMac/Txop/Queue/MaxSize", StringValue ("1p"));
  //Config::Set ("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Mac/$ns3::RegularWifiMac/Txop/Queue/MaxSize",  UintegerValue (1));
