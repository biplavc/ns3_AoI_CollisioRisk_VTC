...
int main (int argc, char *argv[])
{
 ...
 //intervals as per      1,   5,   10,            15,        20,   25,        30            35,          40,             45,         50,            55,                   60,                  65,                  70,                    75,            80 Hz
  ...
  for (int yyy = 0; yyy <kk; yyy++) //loop over intervals
  {
    ...
    int arr[] = {20, 60, 100, 140, 180}; // denotes the number of vehicles
    // int arr[] = {100}; 
    ...
    for (int m = 0; m < mm; m++)
    {
      ...
      // int z = 1;
      // std::cout<<z<<" file(s) created"<<std::endl;
      // z = z+1;
      // std::cout<<file_name<<" generated for yyy = "<<yyy<<", m = "<<m<<std::endl; //verified file ordering and naming
